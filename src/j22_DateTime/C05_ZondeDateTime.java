...
public class C05_ZondeDateTime {
    public static void main(String[] args) {
        ...
        //  ZonedDateTime zdt3=ZonedDateTime.now(ZoneId.of("America"));//RTE-> yerel saat dilimi de tanımlanmalıZonedDateTime zdt2=ZonedDateTime.now(ZoneId.of("Japan"));
