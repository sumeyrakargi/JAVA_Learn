...
public class C13_replaceAll_fill {
    public static void main(String[] args) {
        ...
        Collections.replaceAll(listsayı,1,20);////sayilist'inde 1 yerine 20 değeri atandı
        System.out.println("listsayı = " + listsayı);//replaceAll sonrası-> [20, 24, 23, 14, 19, 60, 20, 55, 27, 20, 38]

        //fill();->listte tüm elelmanları belirli bir değere update der.

        Collections.fill(listsayı,33);//
        System.out.println("listsayı = " + listsayı);////fill sonrası->[33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33]
